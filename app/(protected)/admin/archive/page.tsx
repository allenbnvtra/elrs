      ...
      {stats && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 xs:gap-4">
          <div className="bg-white p-3 xs:p-4 sm:p-5 rounded-2xl xs:rounded-[20px] sm:rounded-3xl border border-gray-200 shadow-sm flex items-center gap-2 xs:gap-3 sm:gap-4">
            <div className="w-10 h-10 xs:w-11 xs:h-11 sm:w-12 sm:h-12 bg-gray-900/5 rounded-xl xs:rounded-2xl flex items-center justify-center text-gray-900 flex-shrink-0">
          ...
          <div className="bg-white p-3 xs:p-4 sm:p-5 rounded-2xl xs:rounded-[20px] sm:rounded-3xl border border-gray-200 shadow-sm flex items-center gap-2 xs:gap-3 sm:gap-4">
            <div className="w-10 h-10 xs:w-11 xs:h-11 sm:w-12 sm:h-12 bg-purple-50 rounded-xl xs:rounded-2xl flex items-center justify-center text-purple-600 flex-shrink-0">
          ...
          <div className="bg-white p-3 xs:p-4 sm:p-5 rounded-2xl xs:rounded-[20px] sm:rounded-3xl border border-gray-200 shadow-sm flex items-center gap-2 xs:gap-3 sm:gap-4 xs:col-span-2 lg:col-span-1">
            <div className="w-10 h-10 xs:w-11 xs:h-11 sm:w-12 sm:h-12 bg-amber-50 rounded-xl xs:rounded-2xl flex items-center justify-center text-amber-600 flex-shrink-0">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <button 
                          onClick={() => handleRestore(item._id)}
                          disabled={!item.canRestore || isRestoring === item._id}
                          className="flex-1 flex items-center justify-center gap-1.5 px-3 xs:px-4 py-2 xs:py-2.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-lg xs:rounded-xl font-bold text-[10px] xs:text-xs hover:bg-emerald-100 transition-all active:scale-95 disabled:opacity-50"
                        >
                          {isRestoring === item._id ? (
                            <>
                              <Loader2 size={14} className="animate-spin" />

...
import {
  X, Plus, AlertCircle, Loader2, CheckCircle2, BookOpen, Eye, EyeOff,
} from "lucide-react";
...
export default function QuestionModal({
  editQuestion, onClose, onSaved, userId, defaultArea, defaultSubject,
}: Props) {
  ...
  const [form, setForm] = useState<FormData>(
    isEdit
      ...
      : { ...EMPTY_FORM, area: defaultArea || "", subject: defaultSubject || "" }
  );
  ...
  // Auto-show option inputs when correct answer requires them
  useEffect(() => {

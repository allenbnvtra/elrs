...
export default function PDFImportModal({ 
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (course === "BSABEN" && !formData.area) {
    ...
    try {
      const res = await fetch("/api/questions/import-pdf", {
        ...
        body: JSON.stringify({
          ...
          defaultArea: course === "BSABEN" ? formData.area : undefined,
        }),
      });
  ...
  const handleClose = () => {
    ...
    setParsedQuestions([]);
    setError("");
    setFormData({ subject: defaultSubject || "", difficulty: "Medium", area: defaultArea || "" });
    onClose();
  };
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder={course === "BSABEN" ? "e.g., Structures and Materials" : "e.g., Surveying, Geodesy"}
                ...
                {course === "BSABEN" && (
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      placeholder="e.g., AREA 3 - Structures and Environment"
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-2xl p-12 text-center hover:border-blue-500 transition-all">
                ...
                <input
                  ...
                  disabled={uploading || !formData.subject || (course === "BSABEN" && !formData.area)}
                  className="hidden"
                />
                <button
                ...
                {course === "BSABEN" && !formData.area && formData.subject && (
                  <p className="text-xs text-red-500 mt-2">Please enter an area first</p>
                )}
              </div>
